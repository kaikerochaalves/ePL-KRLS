...
l_tau = [0.1]
l_beta = [0.4, 0.6]
l_lambda1 = [0.1, 0.001, 0.00001, 0.0000001]
l_sigma = [0.5, 1, 1.5, 3, 5, 7, 10]
l_nu = [0.4, 0.5]
...
result = pd.DataFrame(columns = ['Alpha', 'Tau', 'Beta', 'Lambda', 'Sigma', 'nu', 'e_utility', 'd_max', 'RMSE', 'NDEI', 'MAE', 'Rules'])
                    ...
                    for nu in l_nu:
                        for e_utility in l_e_utility:
                            for d_max in l_d_max:
                                ...
                                result = result.append({'Alpha': alpha, 'Tau': tau, 'Beta': beta, 'Lambda': lambda1, 'Sigma': sigma, 'nu': nu, 'e_utility': e_utility, 'd_max': d_max, 'RMSE': RMSE, 'NDEI': NDEI, 'MAE': MAE, 'Rules': Rules}, ignore_index=True)
